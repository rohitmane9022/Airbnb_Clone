...
export default function BookingSinglePages() {
  ...
  return (
    <div className='my-8'>
      ...
      <a className="my-2 block font-semibold underline flex gap-1" href={"https://maps.google.com/?q="+booking.place.address} target="blank" ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
...
<div className="flex gap-1 items-center ml-2">
 ...
 <div className='bg-primary p-4 text-white rounded-2xl flex flex-col justify-center items-center'>
 <div>Total Price</div>
